...
for (const key of Object.keys(env)) if (/^(STRIPE_|PAYPAL_|SMTP_|RESEND_|AUTH_|MAIL_|SEASON_|PRESEASON_|SANDBOX_|BILLING_|PAYMENT_|PAYMENTS_|LIVE_PAYMENTS_|ADMIN_|BASE_URL$|RENDER)/.test(key)) delete env[key];
